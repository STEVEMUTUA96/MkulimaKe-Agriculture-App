    ...
    <>
      <div className="bg-gray-100 flex flex-col font-roboto items-center justify-start mx-auto pb-[27px] w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-end md:ml-[0] ml-[1086px] mr-[54px] mt-[42px] p-1.5 md:px-5 rounded-[10px] w-[21%] md:w-full">
            <Img
          ...
          <div className="flex flex-row gap-3 items-center justify-end md:ml-[0] ml-[1324px] mt-[13px] md:px-5 w-[5%] md:w-full">
            <Text
              className="text-base text-black-900"
              size="txtRobotoRomanRegular16"
            >
          ...
          <div className="md:h-[538px] h-[555px] max-w-[1354px] mt-[3px] mx-auto md:px-5 relative w-full">
            ...
            <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start left-[4%] my-auto w-[7%]">
              <div className="flex flex-col items-center justify-start">
                <Text
            ...
            <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start my-auto right-[38%] w-[6%]">
              <Text
                className="text-base text-black-900_7e"
                size="txtRobotoRomanRegular16Black9007e"
              >
            ...
            <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start my-auto right-[16%]">
              <Text
                className="text-base text-black-900_7e"
                size="txtRobotoRomanRegular16Black9007e"
              >
            ...
            <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start left-[20%] my-auto">
              <Text
                className="text-base text-black-900_7e"
                size="txtRobotoRomanRegular16Black9007e"
              >
              ...
              <Text
                className="mt-[58px] text-base text-black-900"
                size="txtRobotoRomanRegular16"
              >
                Hoppa
              </Text>

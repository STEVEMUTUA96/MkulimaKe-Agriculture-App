...
const LoginFourteenPage: React.FC = () => {
  return (
    <>
          ...
          <div className="flex flex-col items-center justify-start md:mt-0 mt-[26px]">
            ...
            <div className="flex flex-col items-center justify-start mt-[21px] w-[46%] md:w-full">
              <div className="flex flex-col items-start justify-start w-full">
                ...
                <Button
                  className="cursor-pointer font-semibold h-10 leading-[normal] min-w-[72px] md:ml-[0] ml-[228px] mt-4 text-base text-center"
                  shape="round"
                  color="teal_500"
                  size="md"
                  variant="fill"
                ...
                <div className="flex flex-row items-center justify-between mt-[17px] w-full">
                  ...
                  <a href="javascript:" className="text-base text-black-900">
                    <Text size="txtRobotoRomanRegular16">Forgot password?</Text>
                  </a>
                </div>
              </div>
            </div>

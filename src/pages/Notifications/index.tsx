        ...
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex flex-col items-start justify-start max-w-7xl mt-[15px] mx-auto md:px-5 w-full">
            <div className="flex md:flex-col flex-row gap-7 items-end justify-between w-full">
              <div className="flex md:flex-1 sm:flex-col flex-row md:gap-10 items-start justify-between w-[93%] md:w-full">
                ...
                <div className="bg-white-A700 flex flex-row items-center justify-center sm:mt-0 mt-2.5 p-1.5 rounded-[10px] w-[26%] sm:w-full">
                  <Img

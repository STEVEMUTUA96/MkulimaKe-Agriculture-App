...
const CancelpolicyPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-roboto items-center justify-start mx-auto pb-[27px] w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row gap-[30px] items-center justify-start max-w-[1343px] mt-[21px] mx-auto md:px-5 w-full">
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col items-center justify-start p-2 rounded-[16px] shadow-bs1 w-[48%] md:w-full">
              <div className="flex flex-col items-start justify-start mb-5 mt-2.5 pb-[5px] pr-[5px] w-[99%] md:w-full">
                ...
                <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mb-1 mt-[30px] w-full">
                  <Text
                    className="text-base text-black-900"
                    size="txtRobotoRomanRegular16"
                  >
          ...
          <div className="md:h-[538px] h-[555px] max-w-[1397px] mt-[3px] mx-auto md:px-5 relative w-full">
            <div className="absolute md:h-[535px] h-[555px] inset-[0] justify-center m-auto w-[97%] md:w-full">
            ...
            <Text
              className="absolute bg-white-A700 h-10 justify-center pb-2 pl-4 sm:pr-5 pr-[35px] pt-3 right-[0] rounded-lg text-base text-black-900 text-shadow-ts top-[14%] w-[150px]"
              size="txtRobotoRomanRegular16"
            >
              Cancel policy
            </Text>

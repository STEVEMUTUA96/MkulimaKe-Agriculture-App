      ...
      <div className="bg-gray-100 flex flex-col font-roboto items-center justify-start mx-auto pb-[27px] w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row gap-[30px] items-center justify-start max-w-[1343px] mt-[21px] mx-auto md:px-5 w-full">
            ...
            <div className="bg-white-A700 flex md:flex-1 flex-col gap-[9px] items-center justify-start md:mt-0 mt-2.5 p-[22px] sm:px-5 rounded-[16px] shadow-bs1 w-1/5 md:w-full">
              <Img
          ...
          <div className="flex flex-col items-center justify-start max-w-[1354px] mt-[54px] mx-auto md:px-5 w-full">
              ...
              <div className="md:h-[535px] h-[555px] relative w-full">
                <div className="absolute bottom-[0] flex flex-col inset-x-[0] items-center justify-start mx-auto w-full">
                  <div className="flex flex-col gap-4 items-center justify-start w-full">
                    <div className="bg-white-A700 flex flex-col items-start justify-start p-2 rounded-[10px] w-full">
                      <div className="flex flex-col h-[30px] items-center justify-start my-[7px] w-[30px]">
                ...
                <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start left-[21%] my-auto w-[9%]">
                  ...
                  <Button
                    className="cursor-pointer min-w-[61px] mt-9 rounded-md text-center text-xs"
                    shape="round"
                  ...
                  <Text
                    className="bg-yellow-A700_99 h-[23px] justify-center mt-[53px] pb-0.5 pt-[5px] px-1.5 rounded-md text-black-900 text-center text-xs w-28"

...
const MultipolicyrenewalPage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-roboto items-center justify-start mx-auto pb-[27px] w-full">
        <div className="flex flex-col items-center justify-start w-full">
          ...
          <div className="flex flex-col items-center justify-start max-w-[1354px] mt-[67px] mx-auto md:px-5 w-full">
            <div className="flex flex-col gap-[11px] justify-start w-full">
              <div className="flex sm:flex-col flex-row gap-7 items-end justify-end md:ml-[0] ml-[833px] w-[37%] md:w-full">
                <div className="flex sm:flex-col flex-row gap-5 items-start justify-between w-[82%] sm:w-full">
                  <Button
                  ...
                  <div className="bg-white-A700 flex flex-row items-center justify-center sm:mt-0 mt-1 p-1.5 rounded-[10px]">
                    <Img
                ...
                <div className="flex flex-row gap-3 items-center justify-between sm:mt-0 mt-4 w-[13%] sm:w-full">
                  <Text
                    className="text-base text-black-900"
                    size="txtRobotoRomanRegular16"
                  >
              ...
              <div className="md:h-[535px] h-[555px] relative w-full">
                ...
                <div className="absolute flex flex-col h-max inset-y-[0] items-start justify-start left-[21%] my-auto w-[9%]">
                  ...
                  <Button
                    className="cursor-pointer min-w-[65px] mt-[53px] rounded-md text-center text-xs"
                    shape="round"
                    color="gray_600_99"
                    size="xs"
                    variant="fill"
...
export default MultipolicyrenewalPage;

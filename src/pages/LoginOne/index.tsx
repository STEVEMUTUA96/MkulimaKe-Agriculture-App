...
const LoginOnePage: React.FC = () => {
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-roboto gap-6 items-center justify-start mx-auto pb-[126px] w-full">
        <div className="flex flex-col md:px-5 relative w-full">
          ...
          <div className="md:h-[2044px] sm:h-[669px] h-[701px] mt-[-18.96px] mx-auto w-[89%] md:w-full z-[1]">
              ...
              <div className="flex flex-col items-center justify-start w-full">
                ...
                >
                  <div className="bg-white-A700 flex flex-1 md:flex-col flex-row md:gap-5 items-center justify-start my-0 p-2 rounded-[10px] w-full">
                    <Button
                      className="flex h-[30px] items-center justify-center md:mt-0 my-[7px] rounded-[10px] w-[30px]"
                      color="teal_500"
                      size="xs"
                      variant="fill"
                    >

...
const ChairmanaccountcreationPage: React.FC = () => {
  return (
    <>
              ...
              <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between mt-[27px] w-full">
                <div className="flex md:flex-1 flex-col items-start justify-start w-[47%] md:w-full">
                  ...
                  <Input
                    ...
                    placeholder=""
                    className="p-0 w-full"
                    wrapClassName="border border-black-900 border-solid flex h-[35px] mt-0.5 w-full"
                    shape="round"
                  ></Input>
                </div>
                <div className="flex md:flex-1 flex-col items-start justify-start w-[47%] md:w-full">
...
export default ChairmanaccountcreationPage;
